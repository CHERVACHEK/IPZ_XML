...
що складаються з табличної структури.
...
![s](https://github.com/CHERVACHEK/IPZ_XML/blob/master/2.jpg)
...
![x](https://github.com/CHERVACHEK/IPZ_XML/blob/master/3.png)
...
    }
  ...
  [1. Теоретичні відомості ]: #теоретичні-відомості
  [1.1 CSV-файли ]: #csv-файли
  [1.2 Правила оформлення CSV ]: #правила-оформлення-csv
  [1.3 HML-файли ]: #hml-файли
  [1.4 Опис логічної структури ]: #опис-логічної-структури
  [РОЗДІЛ 2 ]: #розділ-2
  [2.1. Опис програми і тестування програми ]: #опис-програми-і-тестування-програми
  [2.2. Типи комп\'ютерів та пристроїв, що використовуються при роботі програми ]:
    #типи-компютерів-та-пристроїв-що-використовуються-при-роботі-програми
  [2.3. Виклик і завантаження ]: #виклик-і-завантаження
  [ВИСНОВКИ ]: #висновки
